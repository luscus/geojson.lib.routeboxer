...
RouteBoxer.prototype.getGridIntersect_ = function (start, brng, gridLineLat) {
  var d = this.R * ((geoLib.geoLib.tools.numberToRadius(gridLineLat) -
                     geoLib.geoLib.tools.numberToRadius(start[1]) /
                     Math.cos(geoLib.geoLib.tools.numberToRadius(brng))));
  return geoLib.tools.destinationPosition(start, brng, d);
};
